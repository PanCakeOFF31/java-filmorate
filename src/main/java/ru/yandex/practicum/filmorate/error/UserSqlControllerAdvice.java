...
public class UserSqlControllerAdvice {
    private static final String CLASS_NAME = "UserSqlControllerAdvice ";
    ...
    public ErrorResponse handleDuplicateKeyException(final DuplicateKeyException exception) {
        ...
        return new ErrorResponse("Ошибка выполнения SQL запроса",
                "Проблемы связаны с нарушением уникальности данных или первичным ключом. Возможно вы пытаетесь повторно добавить пользователя.", exception.getMessage());
    }
}
